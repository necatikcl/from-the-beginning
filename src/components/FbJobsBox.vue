...
<template>
  <div class="fb-jobs-box">
    <div class="fb-jobs-box-icon">
      <fb-resource-icon v-if="resourceKey" :name="resourceKey" />
      <fb-icon icon="bed" v-else />
    </div>
    <div class="fb-jobs-box-subtitle">{{ computedSubtitle }}</div>
    ...
    <div class="fb-jobs-box-footer">
      ...
      <div class="fb-jobs-box-count">{{ computedCount }}</div>
      <fb-button
        v-if="jobKey"
        :disabled="disabled"
        equal-padding
